  ...
  return (
    ...
    >
      ...
      <section
        ...
        className={`absolute bottom-0 left-0 right-0 mx-auto max-h-[94vh] w-full max-w-xl overflow-y-auto rounded-t-[34px] border-x border-t border-violet-300/15 bg-[#0e0b15] px-4 pb-[max(24px,env(safe-area-inset-bottom))] pt-3 shadow-[0_-30px_90px_rgba(76,29,149,0.4)] transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] sm:bottom-6 sm:max-w-lg sm:rounded-[34px] sm:border ${
          open
            ? "translate-y-0"
            : "translate-y-[110%]"
        }`}
      >
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 rounded-[20px] border border-white/10 bg-white px-4 py-3.5 text-sm font-black text-gray-900 transition hover:bg-gray-100 active:scale-[0.98] disabled:opacity-60"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 rounded-[20px] border border-white/10 bg-black px-4 py-3.5 text-sm font-black text-white transition hover:bg-black/80 active:scale-[0.98] disabled:opacity-60"
          >
